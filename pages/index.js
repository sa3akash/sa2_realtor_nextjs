  ...
  return (
    <Flex flexWrap="wrap" justifyContent="center" alignItems="center" m="10" >
      ...
      <Box p={5}>
        ...
        <Text fontSize="lg" paddingTop="3px" paddingBottom='3px' fontWeight="medium" color='gray.700'
        >
          {desc1} <br /> {desc2}
        </Text>
        <Button size='xl' p='3'>
...
export default function Home({propertiesForSale, propertiesForRent}) {
  return (
    <Box>
      ...
      <Flex flexWrap='wrap' display='flex' alignItems='center' justifyContent='center'>
